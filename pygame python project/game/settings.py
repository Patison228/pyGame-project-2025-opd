...
main_menu_music = pygame.mixer.Sound("pygame python project\sounds\main_menu_music.mp3")
game_music = pygame.mixer.Sound("pygame python project\sounds\game_music.mp3")
